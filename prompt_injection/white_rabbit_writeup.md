...
```
this will reveal 3 clients. from the hint given in the description of the CTF (🐇 📞 🚪), it seems we have to do something with a 'white rabbit' and make a `phone call`. the clients table reveal[...]
...
this reveals the `Flag2` of the challenge aswell as some secret door-code. A person named Tank picks up the call. lets ask the AI systematically who this Tank guy is and reveal information about this [...]
